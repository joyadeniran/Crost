  ...
  return (
    <>
      <nav className="sidebar-nav">
        ...
        <NavItem href="/dashboard/approvals" label="Approvals"    Icon={IconApprovals} badge={pendingCount} />
        <NavItem href="/dashboard/memos"     label="Memos"        Icon={IconMemos} />
        <NavItem href="/dashboard/settings"  label="Constitution" Icon={IconShield} />
        ...
        <NavItem href="/dashboard/settings"  label="Settings"     Icon={IconUser} />
      </nav>
      ...
      <div className="sidebar-bottom" style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
        ...
        <NavItem href="/dashboard/settings" label="Config" Icon={IconSettings} />
      </div>
    </>
  )
}
