          ...
          {!showOtp ? (
            <div className="auth-flow">
              ...
              <div className="social-login">
                <button onClick={() => handleSocialLogin('google')} className="social-btn" title="Sign up with Google">
                  <GoogleIcon />
                </button>
                <button onClick={() => handleSocialLogin('apple')} className="social-btn" title="Sign up with Apple">
                  <AppleIcon />
                </button>
              </div>
